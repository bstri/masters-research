function [p,Ainv] = fadlevVPA(A)
%
% Faddeev-Leverrier algorithm for computing coefficients of the
% characteristic equation and the inverse of a given square matrix
%
